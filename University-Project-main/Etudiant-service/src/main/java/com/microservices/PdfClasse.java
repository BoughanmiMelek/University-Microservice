...
public class PdfClasse {
    ...
    public ResponseEntity<byte[]> generatePdf(@PathVariable Long classId) throws IOException, DocumentException, SQLException {
        ...
        Image logo = Image.getInstance("C:/Users/Malek Boughanmi/Desktop/5sae-Projets/University-Project-main/Etudiant-service/src/main/resources/Logo.png");
        ...
        for (Etudiant etudiant : etudiants) {
            ...
            table.addCell(String.valueOf(etudiant.getAge()));
